...
# 判断是否剪树叶
execute store success score shear_leaves vimiTemp if score @s vimiShearLeaves matches 1 if block 20000016 1 20000016 #logs if data entity @s Inventory[{id:"minecraft:shears",Count:-106b}]
execute if score shear_leaves vimiTemp matches 0 store success score shear_leaves vimiTemp if score @s vimiShearLeaves matches 2 if block 20000016 1 20000016 #logs if data entity @s Inventory[{id:"minecraft:shears"}]
